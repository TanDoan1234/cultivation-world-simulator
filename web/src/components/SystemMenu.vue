      ...
      <div class="menu-content">
              ...
              <div class="setting-label-group">
                <n-icon size="24" color="#eee" class="setting-icon">
                  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
                    <path
                      fill="currentColor"
                      d="M264 416.19a23.92 23.92 0 0 1-14.21-4.69l-.66-.51l-91.46-75H88a24 24 0 0 1-24-24V200a24 24 0 0 1 24-24h69.65l91.46-75l.66-.51A24 24 0 0 1 288 119.69v272.62a24 24 0 0 1-24 23.88Z"
                    />
                    <path
                      fill="currentColor"
                      d="M352 336a16 16 0 0 1-14.29-23.18c9.49-18.9 14.29-39.8 14.29-62.18s-4.8-43.28-14.29-62.18A16 16 0 1 1 366.29 174c12.78 25.4 19.24 53.48 19.24 83.35s-6.46 58-19.24 83.35A16 16 0 0 1 352 336Z"
                    />
                    <path
                      fill="currentColor"
                      d="M400 384a16 16 0 0 1-13.87-24c19.16-32.9 29.3-70.19 29.3-108s-10.14-75.1-29.3-108a16 16 0 1 1 27.74-16c21.85 37.52 33.56 80.77 33.56 124s-11.71 86.48-33.56 124A16 16 0 0 1 400 384Z"
                    />
                  </svg>
                </n-icon>
              ...
              <div class="sound-controls">
                ...
                <div class="volume-row">
                  ...
                  <span class="volume-value"
                    >{{ Math.round(settingStore.bgmVolume * 100) }}%</span
                  >
                </div>
                ...
                <div class="volume-row">
                  ...
                  <span class="volume-value"
                    >{{ Math.round(settingStore.sfxVolume * 100) }}%</span
                  >
                </div>
              </div>
            </div>
        ...
        <div v-else-if="activeTab === 'about'" class="other-panel-container">
          ...
          <div class="other-actions">
            ...
            <button
              ...
              @click="
                openLink(
                  'https://github.com/4thfever/cultivation-world-simulator/blob/main/CONTRIBUTORS.md',
                )
              "
              v-sound
            >
              <div class="btn-content">
                ...
                <div class="btn-text-group">
                  <span class="btn-title">{{
                    t("ui.about_contributors")
                  }}</span>
                  <span class="btn-desc">{{
                    t("ui.about_contributors_desc")
                  }}</span>
                </div>
              </div>
              <div class="btn-arrow">❯</div>
        ...
        <div v-else-if="activeTab === 'other'" class="other-panel-container">
          ...
          <div class="other-actions">
            ...
            <button
              class="custom-action-btn danger-hover"
